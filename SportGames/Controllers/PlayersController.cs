...
namespace SportGames.Controllers
{
    ...
    public class PlayersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PlayerId,Name,Age,Number,TeamId")] Player player)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PlayerId,Name,Age,Number,TeamId")] Player player)
        {
            if (ModelState.IsValid)
            {
